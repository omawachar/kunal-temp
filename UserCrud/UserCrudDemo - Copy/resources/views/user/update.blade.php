    ...
    <div class="container">
        ...
        <form id="update" method="POST" action="{{url('update')}}" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <!-- <img id="blah" class="m-3" src="/image/{{ $user->profile_image }}" width="60px">
                    <input type="file" onchange="readUrl(this);" name="profile_image" class="form-control" placeholder="image" value="{{$user->profile_image}}"> -->
                <div>
                    <label for="">Profile Image</label>
                    <div class="form-group form-inline ">
                        <img id="preview-image-before-upload" class="rounded img-thumbnail" src="{{asset('/storage/images/'.$user->profile_image)}}" alt="preview image" style="max-height: 100px; max-width: 100px; ">

                        <input type="file" class="form-control col" name="profile_image" placeholder="Choose image" id="image">
                        <!-- @error('image')
